...
- Confetti: celebrate session-limit resets with optional full-screen confetti, configurable alongside the existing weekly-limit celebration in Advanced settings. Thanks @bystritskiy!
